...
export interface RREArchNode {
  icon: string;
  label: string;
  color: string;
}

export interface RREStat {
  value: string;
  label: string;
}

export const RRE_ARCH_NODES: RREArchNode[] = [
...
export const RRE_STATS: RREStat[] = [
...
export const RRE_TECH: string[] = ['Java 11/21', 'ScyllaDB', 'Kafka', 'Redis + Redisson', 'Elasticsearch', 'MongoDB', 'Druid', 'SageMaker', 'Neptune'];
